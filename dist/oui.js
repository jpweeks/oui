...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/var TextInput=function(_React$Component){(0,_inherits3.default)(TextInput,_React$Component);function TextInput(){(0,_classCallCheck3.default)(this,TextInput);return(0,_possibleConstructorReturn3.default)(this,(TextInput.__proto__||Object.getPrototypeOf(TextInput)).apply(this,arguments));}(0,_createClass3.default)(TextInput,[{key:'render',value:function render(){var _props=this.props,value=_props.value,label=_props.label,onChange=_props.onChange,style=_props.style,pattern=_props.pattern,onSubmit=_props.onSubmit;var conditionOnChange=function conditionOnChange(value){return pattern.test(value)?onChange(value):null;};var conditionOnSubmit=function conditionOnSubmit(value){return pattern.test(value)?onSubmit(value):null;};return _preact2.default.h('div',{style:(0,_extends3.default)({},_styles.base,style,{display:'flex'})},_preact2.default.h('label',null,label),_preact2.default.h('input',{type:'text',value:value,style:(0,_extends3.default)({},defaultStyle),onInput:function onInput(evt){return conditionOnChange(evt.target.value);},onChange:function onChange(evt){return conditionOnSubmit(evt.target.value);}}));}}]);return TextInput;}(_preact2.default.Component);// TextInput = radium( TextInput )
	// import radium from 'radium'
